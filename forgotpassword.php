...
function sendMail($email, $reset_token)
{
    ...
    try {
        ...
        $mail->Username = 'nonar811@gmail.com';                     //SMTP username
        $mail->Password = 'aysm ossg kekq trkl';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('nonar811@gmail.com', 'Library And Book Shop');
        ...
        <a href='http://localhost/library/updatepassword.php?email=$email&reset_token=$reset_token'>Reset Password</a>";
